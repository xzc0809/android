...
public class OverAdapter extends BaseAdapter {
    ...
    public OverAdapter(List<Car> list) {
        this.cars=list;
    }

    public OverAdapter(Context context, List<Car> cars) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            viewHolder.car_id = (TextView) view.findViewById(R.id.over_p2);
            viewHolder.car_xin = (TextView) view.findViewById(R.id.over_c2);
            viewHolder.no_time = (TextView) view.findViewById(R.id.over_time2);
            viewHolder.btn_yvyue =  view.findViewById(R.id.btn_over);
            view.setTag(viewHolder);
        } else {
            view = convertView;
            viewHolder = (OverAdapter.ViewHolder) view.getTag();
        }
